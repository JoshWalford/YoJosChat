...
class YoJoTextTheme{
  ...
  static TextTheme lightTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.normal, color: Colors.black),
    headlineSmall: const TextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w300, color: Colors.black),

    titleLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.bold, color: Colors.black),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.normal, color: Colors.black),
    titleSmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w300, color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w300, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.normal, color: Colors.white),
    headlineSmall: const TextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w300, color: Colors.white),

    titleLarge: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.bold, color: Colors.white),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.normal, color: Colors.white),
    titleSmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w300, color: Colors.white),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w300, color: Colors.white.withOpacity(0.5)),
